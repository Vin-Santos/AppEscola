const openSuperBrainGamePage = () => {
  ...
  location.href = "../html/superBrainGame.html"
}
...
const placeuserStatistics = () => {
  ...
  document.title = `BrainGame - The world's best way to learn ${getLanguageFullForm(userData.learnLang)}`
