...
animationLoader("BrainGame-feature-animation-stay-motivated", stayMotivated, true);
animationLoader("BrainGame-feature-animation-personalised-learning", personalisedLearning, true);
animationLoader("BrainGame-feature-animation-backed-by-science", backedByScience, true);
animationLoader("BrainGame-feature-animation-free-fun-effective", freeFunEffective, true);
